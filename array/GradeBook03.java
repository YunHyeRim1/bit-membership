...
public class Ex10GradeBook01 {
    ...
    // 객체를 개별 보기 하고 혹시라도 수정 삭제 시에는 관련 메소드를 호출해주는 메소드
    private static Student[] selectOne(Scanner scanner, 
            Student[] studentArray, int index) {
        
        // 먼저 파라미터로 넘어온 studentArray에서 index를 사용하여
        // 사용자가 선택한 객체를 출력해보자.
    ...
    private static Student[] deleteStudent(Scanner scanner, Student[] studentArray, int index) {
        System.out.printf("해당 학생을 정말 삭제하시겠습니까 y/n : ");
