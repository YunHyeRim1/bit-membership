    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if(userChoice == 1) {
                ...
                // 만약 플레이어가 한 번이라도 플레이했다면
                // 최고 기록은 0이 될 수 없다.
                // if=else 구조를 사용해서
                // bestScore가 0이면,
                // "아직 플레이한 기록이 없습니다" 라는 메시지를 출력하고
                // 그 외에는 "현재 최고 기록은 ##회 입니다!" 라고 출력되게 만들어주자
                if(bestScore == 0) {
                    System.out.println("아직 플레이한 기록이 없습니다!");
                }else {
                    System.out.printf("현재 최고 기록은 %d회 입니다!", bestScore);
                }
