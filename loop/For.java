...
=======
// for 반복문: 비교적 횟수가 명확하게 나옴.
// while 반복문: 조건식이 true인 동안 계속 돌아감.

// for 반복문
// 제어변수가 특정 조건식을 만족하는 동안 코드를 반복하고
// 제어변수의 값을 변화시켜서 다시 조건식을 체크해서 ture면 반복, false면
...
=======
        ...
        //     반복할 코드
        // }
        // 제어변수의 선언과 초기화는 for문 이전에 선언과 초기화해줘도 괜찮다.
>>>>>>> 02bb71477c4c8cdccfe81c1929f0e810d1379a8e
...
=======
        // 또한, 여러분들이 흔히 하는 실수 중에 for() 뒤에 곧장 ; 을 붙이는데 의미가 달라지게 된다.
        for(int i = 0; i < 4; i++); {
            System.out.println("몇 번 반복될까?");
>>>>>>> 02bb71477c4c8cdccfe81c1929f0e810d1379a8e
        }
        // 위 코드에서 ; 이 붙음으로써
...
=======
        ...
        // 가 메모리 영역에 4번 등록이 되지만
        // 지금 같은 경우에는 딱 1번 등록이 된다.
        // 즉 해당 코드 블락은 for 반복문에 포함된 것이 아니라
        // 그저 별개의 코드 한 줄이 된 것이다.
        
        // 또한 컨트롤 변수는 해당 for문에서 선언됐을 때에는
        // 스코프가 해당 for문이다.
        for(int i = 0; i < 4; i++) {
            System.out.println(i); // 여기는 scope니까 문제 없음
        }
        // System.out.println(i); // scope를 벗어났으므로 에러
>>>>>>> 02bb71477c4c8cdccfe81c1929f0e810d1379a8e
        int i = 0;
...
=======
        // for 반복문의 () 안에는 무조건 ;이 2번 나와야 한다.
        // 그러므로 선언과 초기화를 밖으로 뺄 때에는 ;조건식;변화식 이렇게 적어야 한다.
>>>>>>> 02bb71477c4c8cdccfe81c1929f0e810d1379a8e
    }
}
